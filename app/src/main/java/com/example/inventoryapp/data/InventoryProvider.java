...
public class InventoryProvider extends ContentProvider {
    ...
    static {
        ...
        // The content URI of the form "content://com.example.inventory/inventory" will map to the
        ...
        // For example, "content://com.example.inventory/inventory/3" matches, but
        // "content://com.example.inventory/inventory" (without a number at the end) doesn't match.
    ...
    public Cursor query(Uri uri, String[] projection, String selection, String[] selectionArgs,
        ...
        switch (match) {
            ...
            case INVENTORY_ID:
                ...
                // For an example URI such as "content://com.example.inventory/inventory/3",
    ...
    private Uri insertInventoryItem(Uri uri, ContentValues values) {
        ...
        // Notify all listeners that the data has changed for the inventory item content URI
     ...
     */
    private int updateInventoryItems(Uri uri, ContentValues values, String selection, String[] selectionArgs) {
        // If the {@link InventoryEntry#COLUMN__NAME} key is present,
